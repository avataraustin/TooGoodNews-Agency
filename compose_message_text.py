...
def compose_message_html():
  ...
  final_string += """<h6>These articles were intended to be written as overly optimistic satire while preserving the facts, however it is possible that the satire may overshadow the facts. Please visit the "Inspiration for this satire" links for more factual details. </h6>"""
